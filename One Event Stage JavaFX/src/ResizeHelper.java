...
/**
 * This Class allows user to resize an undecorated Stage
 * Borrowed from answer on Stackoverflow
 * Credits to stackoverflow.com/users/325554/alexander-berg
 * @author Alexander Berg
 * @version 03/06/2014
 */
public class ResizeHelper {
	static boolean isDraging = false; // added a boolean to arrange between moving and resizing when click on the title bar
    ...
    public static void addListenerDeeply(Node node, EventHandler<MouseEvent> listener) {
        ...
        node.getScene().addEventHandler(MouseEvent.MOUSE_RELEASED, listener);
    ...
    static class ResizeListener implements EventHandler<MouseEvent> {
        ...
        public void handle(MouseEvent mouseEvent) {
            ...
            if(MouseEvent.MOUSE_RELEASED.equals(mouseEventType)==true){// added to detected mouse release
            	isDraging = false;
            }
            else if (MouseEvent.MOUSE_MOVED.equals(mouseEventType) == true) {
